...
public protocol IFireStore {
    var db: Firestore { get }
}

public struct FireStore: IFireStore {
...
//
//extension FireStoreGateway {
//    func createLogin(loginData: LoginData) async throws {
//        try db.collection(loginCollectionKey).document(loginData.userID).setData(from: loginData)
//    }
//
